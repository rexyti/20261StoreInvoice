...
1. Scenario: Asignación exitosa a cliente existente
	...
	- **When:** El asesor selecciona la opción "Pago Contra Entrega (COD)" y guarda los cambios
...
**Why this priority:** Protección financiera de la distribuidora.
...
- **FR-001**: System MUST permitir la selección entre al menos dos formas de pago: "Pago Contra Entrega (COD)" y "Cartera Comercial".
- **FR-002:** System MUST requerir que el cliente exista en la base de datos (Include: Registrar cliente) antes de guardar la forma de pago.
...
- **SC-002:** El cambio de forma de pago debe actualizarse en tiempo real para no afectar los pedidos generados en los siguientes 5 minutos.