...
### User Story 1 - Cálculo automatizado de liquidación según efectividad y precio (Priority: P1)
...
- **FR-003**: El sistema MUST calcular la "tarifa base" del transportista extrayendo exactamente el 10% del precio total del pedido.
...
- **SC-001**: El 100% de las liquidaciones generadas reflejan exactamente el cálculo del 10% del precio del pedido ajustado por la matriz de efectividad.
